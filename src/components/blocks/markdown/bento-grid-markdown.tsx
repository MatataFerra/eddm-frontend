...
export function BentoGridMarkdown({ children, slides }: BentoGridProps) {
  ...
  return (
    <>
      <div className="grid grid-cols-1 md:grid-cols-3 auto-rows-[200px] gap-4 my-8">
        {React.Children.map(children, (child, i) => {
          ...
          if (isHero) spanClasses = "md:col-span-2 md:row-span-2";
            ...
            if (itemCount % 3 === 1) spanClasses = "md:col-span-3 md:row-span-1";
            else if (itemCount % 3 === 2) spanClasses = "md:col-span-2 md:row-span-1";
